...
client.login("NzYzNzM4ODA2MjI1NzMxNTk0.X38FMA.Hq8bbuCeUHceKGdA0HDn3tiQz3w");
const queue = new Map();
...
client.on("ready", () => {
  ...
  let statuses = [
    `p!help | Servers: ${client.guilds.size} | Users: ${client.users.size}`,

    `p!help |`,

    `p!help | i'ts time to secure your server`
  ];
  ...
  setInterval(function() {
    ...
    client.user.setActivity(STREAMING, {
      ...
      url: "https://www.twitch.tv/ToOFaN/twicher"
    });
  }, 3000);
});

client.on("guildCreate", guild => {
  client.channels.get("741037339597471819")
  ...
  if (command == "say") {
    if (!message.member.hasPermission("ADMINISTRATOR"))
      return message.channel.send(
        "**ببورە تۆ ڕۆڵت نیە بۆیە ناتوانین ئەم کارە ئەنجام بدەیت | 🔒**"
      );
...
client.on("message", message => {
  if (message.content.includes("@everyone@everyone")) {
    if (!message.member.hasPermission("ADMINISTRATOR")) {
      ...
      message.reply("__** تۆ ناتوانییت ئێڤریوەن لێبدەیت **__| :lock:");
    }
  }
});
...
////كود تيكت
client.on("message", message => {
  if (message.content.startsWith(prefix + "hdvhsvshbshshd")) {
    ...
    message.guild
      ...
      .catch(console.error);
  } else if (message.content.startsWith(prefix + "closethdhdhgsvshd")) {
    if (!message.guild.roles.exists(gg => gg.name === "Support Team"))
      return message.channel.send(` لازم تسوي رتبة اسمها \`Support Team\`.`);
  ...
  if (args[0] == `${prefix}cr`) {
    ...
    try {
      let role = await message.guild.createRole({
        name: args.slice(2).join(" ") || "new rhdygdhdvdhdvdhdvgdvdgdvole",
...
client.on("message", pixelbot => {
  // itzZa1D - Codes Team.
  if (pixelbot.content.startsWith(prefix + "userinfo")) {
    // itzZa1D - Codes Team.
    ...
    pixelbot.guild.fetchInvites().then(invites => {
      ...
      let pixeluser = new Discord.RichEmbed() // itzZa1D - Codes Team.
        .setColor("#00000")
        .setTitle("__**User Info : 👤**__") // itzZa1D - Codes Team.
        .setAuthor(pixelbot.author.username, pixelbot.author.avatarURL)
        .addField("__**Name : **__", pixelbot.author.username, true)
        .addField("__**Tag : **__", pixelbot.author.discriminator, true)

        .addField("__**ID : **__ ", pixelbot.author.id, true) // itzZa1D - Codes Team.
        .addField(
          "__**Joined At : **__   ",
        ...
        .addField("__**Total invites : **__    ", inviteCount, true)
...
client.on("message", message => {
  if (message.content === prefix + "about") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@745701072370401490>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage(
        "https://cdn.discordapp.com/attachments/738855638645342240/744698746377601190/PicsArt_08-17-02.10.51.png"
      )
...
client.on("message", message => {
  ...
  if (command == "banydhhdgdgdyryryryff") {
    if (message.author.bot) return;
...
client.on("message", async message => {
  if (message.content.startsWith(prefix + "infhxhdhdhdydydyfugub")) {
    //// وهون الامر طبعا
...
client.on("message", message => {
  if (message.content.split(" ")[0] === prefix + "avthchchchdydydyc") {
...
client.on("message", message => {
  ...
  if (command === prefix + "unmutyxgcyycycycyvg g gvhhchce") {
    if (message.author.bot) return;
...
client.on("message", message => {
  ...
  if (command === prefix + "muthxhdhdydydhfhbfbfve") {
    if (message.author.bot) return;
    if (!message.member.hasPermission("MANAGE_ROLES"))
      return message
        .reply("** لا يوجد لديك برمشن 'Manage Roles' **")
...
client.on("message", message => {
  if (message.content === prefix + "lock") {
    if (!message.channel.guild)
      return message.reply(
        " ئەم کۆماندە تەنها لە سێرڤەر دەتوانی کاری پێبکەی !!"
      );

    if (!message.member.hasPermission("MANAGE_MESSAGES"))
      return message.reply(
        " __**ببورە تۆ ڕۆڵت نیە بۆیە ناتوانی ئەم کارە ئەنجام بدەیت | 🔓**__"
      );
    message.channel
      ...
      .then(() => {
        message.reply("**بەسەرکەوتویی توانرا چەنال دابخرێت | 🔒**");
      });
  }
  if (message.content === prefix + "unlock") {
    if (!message.channel.guild)
      return message.reply(
        " ئەم کۆماندە تەنها لە سێرڤەر دەتوانی کاری پێبکەیت  !!"
      );

    if (!message.member.hasPermission("MANAGE_MESSAGES"))
      return message.reply(
        "__**ببورە تۆ ڕۆڵت نیە بۆیە ناتوانی ئەم کارە ئەنجام بدەی | 🔒**__"
      );
    message.channel
      .overwritePermissions(message.guild.id, {
        SEND_MESSAGES: true
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "movhchchfhfyfyve")) {
    if (message.member.hasPermission("MOVE_MEMBERS")) {
      if (message.mentions.users.size === 0) {
        return message.channel.send(
          "``Use : " + prefix + "move @Uhxbhdhdhhdhdser``"
        );
      }
...
client.on("message", message => {
  if (message.content === "p!help") {
    const embed = new Discord.RichEmbed()
      ...
      .setImage(
        "https://cdn.discordapp.com/attachments/732159885705478185/737684323796254831/image0-37.gif"
      )
...
p!settings limitsban
p!settings limitskick
p!settings limitschannelC
p!settings limitschannelD
p!settings limitsroleC
p!settings limitsroleD
p!settings limitstime
p!antibots on
p!antibots off
...
__**For More Information Join This server 🔻**__
...
`
      ...
      .setURL("") // Type Your Link here after ''
...
client.on("message", message => {
  if (message.content === "p!invite") {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setTitle("__**=-->بۆ ڕاکێشانی بۆتەکە کلیک بکە لەم تێکستە<--=**__")

      .setImage("")

      .setURL(
        "https://discord.com/api/oauth2/authorize?client_id=763738806225731594&permissions=8&scope=bot" 
...
client.on("message", message => {
  if (message.content === "p!support") {
    const embed = new Discord.RichEmbed()
      ...
      .setTitle("Premium Editors")

      .setImage(
        "https://discord.com/api/oauth2/authorize?client_id=763738806225731594&permissions=8&scope=bot"
      )

      .setURL(`https://discord.gg/bRkqU7Q`)
      .setFooter("by : SOLO");
    message.author.sendEmbed(embed);
...
client.on("message", async message => {
  ...
  if (message.content.startsWith(prefix + "giveawhfhfhhfhfhfhay")) {
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "sethdhdhudhdyLog")) {
    if (!message.channel.guild)
      return message.reply("**This Command Only For Servers**");
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "toggleLbchfhhfhfog")) {
    if (!message.channel.guild)
      return message.reply("**This Command Only For Servers**");
    if (!message.member.hasPermission("MANAGE_GUILD"))
      return message.channel.send(
...
client.on("message", message => {
  if (message.content === "السلhdhudbshzام عليكم") {
...
client.on("message", message => {
  let args = message.content.split(" ").slice(1);
  if (message.content.split(" ")[0] == prefix + "cojfhfhdbhdbxlor") {
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "sayhdhhfhfhf")) {
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "setting")) {
    if (message.author.id !== message.guild.owner.user.id)
      return message.channel.send(
        "**:closed_lock_with_key: تەنها ئۆنەر دەتوانێت دەست کاریبکات**"
      );
    if (message.content.startsWith(prefix + "settings limitsban")) {
      if (!num)
        return message.channel.send(
          "**:1234: | تکایە لە دوای کۆماندە یەکێک لەم ژمارانە بنوسە 1-2-3-4 ! **"
        );
      if (isNaN(num)) return message.channel.send("**:1234: | أرقام فقط ! **");
      config[message.guild.id].banLimit = num;
      message.channel.send(
        `**:lock: | کاراکرا گەر کەسێک  ${config[message.guild.id].banLimit} کەس باند بکا ئەوا خۆی باند دەبێت **`
      );
    }
    if (message.content.startsWith(prefix + "settings limitskick")) {
      if (!num)
        return message.channel.send(
          "**:1234: | تکایە ژمارە لەدوای کۆماندە کە بنوسە ! **"
        );
      if (isNaN(num)) return message.channel.send("**:1234: | أرقام فقط ! **");
      config[message.guild.id].kickLimits = num;
      message.channel.send(
        `**:lock: | کاراکرا گەر کەسێک  ${config[message.guild.id].kickLimits}کەس کیک بکات باند دەبێت **`
      );
    }
    if (message.content.startsWith(prefix + "settings limitsroleD")) {
      if (!num)
        return message.channel.send(
          "**:1234: | تکایە لە دوای کۆماندە کە ژمارە بنوسە! **"
        );
      if (isNaN(num)) return message.channel.send("**:1234: | أرقام فقط ! **");
      config[message.guild.id].roleDelLimit = num;
      message.channel.send(
        `**:lock: | کاراکرا گەر کەسێک  ${config[message.guild.id].roleDelLimit} ڕۆڵ بسڕێتەوە باند دەبێت **`
      );
    }
    if (message.content.startsWith(prefix + "settings limitsroleC")) {
      if (!num)
        return message.channel.send(
          "**:1234: | تکایە ژمارە لە دوای کۆماندە کە بنوسە ! **"
        );
      if (isNaN(num)) return message.channel.send("**:1234: | أرقام فقط ! **");
      config[message.guild.id].roleCrLimits = num;
      message.channel.send(
        `**:lock: | کاراکرا گەر کەسێک ${config[message.guild.id].roleCrLimits} ڕۆڵ دروست بکا ئەوا باند دەبێت**`
      );
    }
    if (message.content.startsWith(prefix + "settings limitschannelD")) {
      if (!num)
        return message.channel.send(
          "**:1234: | أتکایە ژمارە لە دوای کۆماندە کە بنوسە! **"
        );
      if (isNaN(num)) return message.channel.send("**:1234: | أرقام فقط ! **");
      config[message.guild.id].chaDelLimit = num;
      message.channel.send(
        `**:lock: | کاراکرا گەر کەسێک  ${config[message.guild.id].chaDelLimit}چەنال بسڕێتەوە باند دەکری**`
      );
    }
    if (message.content.startsWith(prefix + "settings limitschannelC")) {
      ...
      message.channel.send(
        `**:lock: | کاراکرا گەر کەسێک ${config[message.guild.id].chaCrLimit} چەناڵ دروست بکا باند دەکرێ**`
      );
    }
    if (message.content.startsWith(prefix + "settings limitstime")) {
      if (!num)
        return message.channel.send(
          "**:1234: | تکایە لەدوای کۆماندەکە ژمارە بنوسە! **"
        );
      if (isNaN(num)) return message.channel.send("**:1234: | أرقام فقط ! **");
      config[message.guild.id].time = num;
      message.channel.send(
        `**:lock: | کاراکرا ڕۆڵ بەدەستەکان لە توانایان دایە ${config[message.guild.id].time} جار دەست کاری سێرڤەر بکەن**`
      );
    }
  }
      ...
      channel.guild.members
        ...
        .catch(e =>
          channel.guild.owner.send(
            `**⇏ | ${entry.username} ئەم بەڕێزە چەناڵێکی سڕیەوە لە سێرڤەرەکەت **`
          )
        );
      anti[channel.guild.id + entry.id].actions = "0";
  ...
  if (!anti[channel.guild.id + entry.id]) {
    ...
    if (
      ...
      channel.guild.members
        ...
        .catch(e =>
          channel.guild.owner.send(
            `**⇏ | ${entry.username} ئەم بەڕێزە چەناڵ دروست دەکات لە سێرڤەرەکەت **`
          )
        );
      anti[channel.guild.id + entry.id].actions = "0";
      fs.writeFile("./config.json", JSON.stringify(config, null, 2), function(
  ...
  if (!anti[channel.guild.id + entry.id]) {
    ...
    if (
      ...
      channel.guild.members
        ...
        .catch(e =>
          channel.guild.owner.send(
            `**⇏ | ${entry.username} ئەم بەڕێزە ڕۆڵێکی سڕیەوە لەسێرڤەرەکات **`
          )
        );
      anti[channel.guild.id + entry.id].actions = "0";
      fs.writeFile("./config.json", JSON.stringify(config, null, 2), function(
  ...
  if (!anti[channel.guild.id + entry.id]) {
    ...
    if (
      ...
      channel.guild.members
        ...
        .catch(e =>
          channel.guild.owner.send(
            `**⇏ | ${entry.username} ئەم بەڕێزە ڕۆڵێکی دروست کرد لە سێرڤەرەکەت **`
          )
        );
      anti[channel.guild.id + entry.id].actions = "0";
      fs.writeFile("./config.json", JSON.stringify(config, null, 2), function(
  ...
  if (!anti[guild.id + entry.id]) {
    ...
    if (anti[guild.id + entry.id].actions >= config[guild.id].banLimit) {
      guild.members
        ...
        .catch(e =>
          guild.owner.send(
            `**⇏ | ${entry.username} ئەم بەڕێزە کەسێکی باند کرد لە سێرڤەرەکەت**`
          )
        );
      anti[guild.id + entry.id].actions = 0;
      fs.writeFile("./config.json", JSON.stringify(config, null, 2), function(
    ...
    if (!anti[member.guild.id + entry.id]) {
      ...
      if (
        ...
        member.guild.members
          ...
          .catch(e =>
            member.owner.send(
              `**⇏ | ${entry.username} ئەم بەڕێزە کەسێکی دەرکرد لەسێرڤەر**`
            )
          );
        anti[member.guild.id + entry.id].actions = 0;
        fs.writeFile("./config.json", JSON.stringify(config, null, 2), function(
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "antibots on")) {
    ...
    if (message.author.id !== message.guild.owner.user.id)
      return message.channel.send(
        "**:closed_lock_with_key: تەنها ئۆنەر دەتوانێ دەست کاریبکات**"
      );
    antibots[message.guild.id] = {
      onoff: true
    };
    saveSteve();
    message.channel.send("**ئەنتیبۆت کاراکرا :closed_lock_with_key: **");
  }
  if (message.content.startsWith(prefix + "antibots off")) {
    ...
    saveSteve();
    message.channel.send("**ئەنتیبۆت لابرا:unlock: **");
  }
  saveSteve();
});
...
client.on("message", async message => {
  ...
  var filter = m => m.author.id === message.author.id;
  if (message.content.startsWith(prefix + "gcreبجهجهێدهفate")) {
...
/////كود صنع رد تلقائي
client.on("message", async message => {
  if (message.content.startsWith(prefix + "replyhjhuuu")) {
...
client.on("message", async message => {
  ...
  let room = message.content.split(" ").slice(1);
  let findroom = message.guild.channels.find(r => r.name == room);
  if (message.content.startsWith(prefix + "setWelcomjfhhfbdhder")) {
    if (!welcome[message.guild.id]) {
      ...
      if (!room) return message.channel.send("welcome");
      if (!findroom) return message.channel.send("welcome");
      let embed = new Discord.RichEmbed()
...
client.on("baxer byt dl dl", async message => {
  let messageArray = message.content.split("baxer byt dldl");
  if (message.content.startsWith(prefix + "setMessabcbchhchchge")) {
...
client.on("message", message => {
  if (message.content === prefix + "lchhufhdhdds") {
    var list_all = [];
...
client.on("message", message => {
  if (message.content.split(" ")[0] === prefix + "رابhchbfnfط") {
    message.channel
      .createInvite({
        thing: true,
        maxUses: 5,
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "sehfhfyhdydtVc")) {
  ...
  if (message.content.startsWith(prefix + "vc ofbchchhddf")) {
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "dbhdhdhdhdyydycycy")) {
    if (!message.channel.guild) return;
    if (message.author.bot) return;
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "roohfhudhfm1")) {
    if (!message.channel.guild) return;
    if (message.author.bot) return;
...
client.on("message", message => {
  ...
  if (!message.guild) return;
  if (!msg.startsWith(prefix + "rolchhhfhde")) return;
  if (!message.member.hasPermission("MANAGE_ROLES"))
...
client.on("message", async message => {
  ...
  if (message.content.startsWith(prefix + "قhchhfhfبول")) {
...
client.on("message", async message => {
  if (message.content.startsWith(prefix + "رفhchhdfض")) {
    if (!message.channel.guild) return;
...
client.on("message", message => {
  if (message.content.startsWith(prefix + "rohchhchfom2")) {
    if (!message.channel.guild) return;
    if (message.author.bot) return;
    if (!message.member.hasPermission("MANAGE_CHANNELS"))
      return message.reply("**تحتاج الى `MANAGE_CHANNELS`**");
...
let cmds = {
  ...
  skip: { cmd: "skip", a: ["shfhhf", "تخطى"] },
  stop: { cmd: "stoffffffp", a: ["ايقاف"] },
  pause: { cmd: "paufffse", a: ["ايقاف مؤقت"] },
  resume: { cmd: "reffsume", a: ["hfhhr", "كمل"] },
  volume: { cmd: "volume", a: ["vohhfhhl", "صوت"] },
  queue: { cmd: "quefue", a: ["qyhfhh", "قائمة"] },
  repeat: { cmd: "repdffeat", a: ["reyhfhf", "تكرار"] },
  forceskip: { cmd: "fffforceskip", a: ["تخطي الكل", "fskyfyufip"] },
  skipto: { cmd: "skidfpto", a: ["syfuuft", "اذهب الى"] },
  nowplaying: { cmd: "Nowdffplaying", a: ["nphfhhf", "الان"] }
};
